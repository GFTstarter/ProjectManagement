...
public class ConceptResource {
	...
	public String list() throws JsonGenerationException, JsonMappingException, IOException {
		...
		List<Concept> allEntries = this.conceptDao.findAll();
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path("{id}")
	public Concept read(@PathParam("id") Long id) {

		this.logger.info("getEntry(id)");

		Concept newsEntry = this.conceptDao.find(id);
		if (newsEntry == null) {
	...
	public Concept create(Concept newsEntry) {

		this.logger.info("create(): " + newsEntry);

		return this.conceptDao.save(newsEntry);
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("{id}")
	public Concept update(@PathParam("id") Long id, Concept newsEntry) {
